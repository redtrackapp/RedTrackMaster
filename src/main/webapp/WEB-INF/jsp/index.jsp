...
function onchangeAppId(selectObject) {
	 ...
	 //  alert(appID);
	  ...
	  document.getElementById('submitapplicationFormBean').action = "/redtrack/onchangeAppId";
...
<body>
		...
		<div id="content">	
			...
			<form name="submitapplicationFormBean" id="submitapplicationFormBean" method="POST" action="/redtrack/submitapplicationFormBean">
			<section id="main">
				<article>
