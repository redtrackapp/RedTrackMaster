...
function onchangeAppId(selectObject) {
	 ...
	 //  alert(appID);
	  ...
	  document.getElementById('saveApplicaitonStatusForm').action = "/redtrack/onchangeAppIdforStatus";
...
<body>
		...
		<div id="content">	
			 ...
			 <nav>
			 	<a href="/redtrack/adminModule" id="updateappmappingid" style="font-weight: bold; font-size: 13px;">Update existing application</a> |
			  	<a href="/redtrack/addNewApplicaiton"  style="font-weight: bold; font-size: 13px;">Add new application</a> | 
			  	<a href="/redtrack/updateApplicaitonStatus" style="font-weight: bold; font-size: 13px;">Update application status</a>    
			...
			<form:form  name="saveApplicaitonStatusForm" id="saveApplicaitonStatusForm" method="POST" action="/redtrack/saveApplicaitonStatusForm" 
